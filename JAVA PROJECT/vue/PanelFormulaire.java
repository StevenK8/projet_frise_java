...
public class PanelFormulaire extends JPanel{
	...
	private JLabel date;
	private JComboBox<Integer> jour;
	private JComboBox<Integer> mois;
	private JComboBox<Integer> annee;
	private JLabel descriptif;
	private JTextArea saisieDescriptif;
	private JLabel poids;
	private JComboBox<Integer> saisiePoids;
	...
	public PanelFormulaire() {
		...
		position.gridwidth = 1;
		add(poids, position);
		saisiePoids = new JComboBox<Integer>();
		position.gridx = 1;
